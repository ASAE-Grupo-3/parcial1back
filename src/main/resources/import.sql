...
INSERT INTO `asignaturas` (`idAsignatura`, `nombre`) VALUES (2, 'Ingeniería de Requisitos'); 
INSERT INTO `cursos` (`idCurso`, `nombre`, `periodo`, `idAsignatura`) VALUES (1, 'A', '2022-2',1); 
